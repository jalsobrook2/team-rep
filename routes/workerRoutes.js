...
router.get('/workers/:id/reviews', require('../controllers/workerController').getReviews);
// POST /api/workers/:id/reviews → post a review for a worker (protected)
router.post('/workers/:id/reviews', authMiddleware, require('../controllers/workerController').postReview);
